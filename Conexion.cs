...
namespace Hospital_C_
{
    public static class Conexion
    {
        ...
        public static SqlConnection conexionn = new SqlConnection("data source=CELINA\\SQLEXPRESS; initial catalog=Hospital; integrated security=SSPI; persist security info=false; trusted_connection=yes;");
